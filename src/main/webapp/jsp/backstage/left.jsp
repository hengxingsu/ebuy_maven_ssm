...
<dl class="leftmenu">
    ...
    <dd>
        ...
        <ul class="menuson">
            <li><cite></cite><a href="#" target="rightFrame">产品分类管理</a><i></i></li>
            <li><cite></cite><a href="#" target="rightFrame">产品管理</a><i></i></li>
    ...
    <dd>
        ...
        <ul class="menuson">
            <li><cite></cite><a href="#" target="rightFrame">客户管理</a><i></i></li>
        </ul>
    </dd>
